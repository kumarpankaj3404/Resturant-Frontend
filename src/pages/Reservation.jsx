...
//       }}
//     >
//       {/* Overlay for extra blur if needed */}
//       <div className="absolute inset-0 bg-black/30"></div>

//       {/* Content wrapper */}
//       <div className="relative flex flex-1 w-full">
//         {/* Reservation form */}
//         <div className="flex flex-col justify-center items-center flex-1 h-full bg-white/90 dark:bg-[#6d6e6f]/90 overflow-y-auto p-8 rounded-xl shadow-lg m-6">
//           <div className="px-4 text-center font-heading sm:px-6 lg:px-8">
//             <h2 className="text-4xl font-bold text-[#583f36] dark:text-[#86C232]">
//               {RESERVATION_SECTION.title}
//             </h2>
...
const ReservationSection = () => {
  ...
  return (
    <section
      aria-label="Reservation Section"
      className="relative flex flex-col items-center w-full  bg-gray-100 dark:bg-[#2e2e2e]"
    >
      <div className="bg-[#48352f] h-20 w-full"></div>
      {/* Slim decorative strip above form */}
      ...
      {/* Reservation form */}
      <div className="flex flex-col justify-center items-center w-full max-w-3xl h-auto bg-white/80 dark:bg-[#6d6e6f]/70 backdrop-blur-md overflow-y-auto p-10 rounded-2xl shadow-2xl">
        <div className="px-4 mb-6 text-center font-heading sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-[#583f36] dark:text-[#86C232]">
            {RESERVATION_SECTION.title}
          </h2>
