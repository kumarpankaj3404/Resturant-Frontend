...
//       {/* Left images */}
//       <div className="hidden w-1/4 h-screen lg:block">
//         <VerticalImageColumn />
//       </div>

//       {/* Reservation form */}
//       <div className="flex flex-col justify-center items-center w-full lg:w-2/4 h-screen bg-[#F6ECE3] dark:bg-[#6d6e6f] overflow-y-auto">
