...
//   console.log("Reservation allowed!");
...
//           {/* Form */}
//           <div className="order-2 mt-20 lg:order-1">
...
//   className="w-full hover:text-gray-100 hover:bg-[#7f6257] font-body dark:bg-[#82c91e] dark:text-black"
// >
//   {isAuthenticated ? RESERVATION_SECTION.buttonText : "Login to Book"}
// </Button>
//               </div>
//             </form>
//           </div>
...
const ReservationSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    console.log("Reservation allowed!", formData);
      ...
      <div className="px-4 mx-auto mt-10 max-w-7xl sm:px-6 lg:px-8">
        <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="order-2 mt-20 lg:order-1">
            ...
            <form onSubmit={handleSubmit} onClick={!isAuthenticated ? handleFieldFocus : undefined} className="space-y-6">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 font-body">
