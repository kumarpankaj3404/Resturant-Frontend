...
//       className={`fixed top-0  left-0 w-full z-50 px-4 py-4 shadow-sm backdrop-blur-md transition-transform duration-300 h-12 ${
...
//               key={link.text}
//               to={link.path}
//               className="text-sm  text-black dark:text-white  transition-all duration-300  hover:text-[#7a5f55] dark:hover:text-[#86C232]"
//             >
//               {link.text}
//             </Link>
//           ))}
