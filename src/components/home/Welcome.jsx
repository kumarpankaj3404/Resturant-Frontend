...
const Welcome = () => {
  ...
  return (
    ...
    <section className="flex flex-col-reverse items-center w-full min-h-screen px-4 py-10 bg-[#F6ECE3] sm:px-6 md:flex-row md:px-10 lg:px-24 dark:bg-gray-900 space-x-10">
      ...
      >
          ...
          <p className="text-sm text-black sm:text-base md:text-lg font-body">
          ...
          >
            <button
              ...
              className="px-5 py-2 transition  duration-300 border border-black font-body hover:bg-white dark:hover:bg-[#86C232] hover:text-black "
            >
             Our Story
            </button>
